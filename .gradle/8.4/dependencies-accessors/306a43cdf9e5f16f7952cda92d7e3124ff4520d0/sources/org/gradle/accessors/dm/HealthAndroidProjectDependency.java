...
@NonNullApi
public class HealthAndroidProjectDependency extends DelegatingProjectDependency {

    @Inject
    public HealthAndroidProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
